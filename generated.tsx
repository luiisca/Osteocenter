...
export type ArticleManyWhereInput = {
  ...
  references_contains_all?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  references_contains_none?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  references_contains_some?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  references_not?: InputMaybe<Array<Scalars['String']>>;
...
export type ScheduledOperationAffectedDocument = Article | Asset | Author | Category | Comment;
...
export type ArticlesQuery = { __typename?: 'Query', articles: Array<{ __typename?: 'Article', publishedAt?: any | null, id: string, slug: string, title: string, excerpt: string, featuredPost: boolean, content: { __typename?: 'RichText', html: string }, categories: Array<{ __typename?: 'Category', id: string }>, featuredImage: { __typename?: 'Asset', id: string } }> };
