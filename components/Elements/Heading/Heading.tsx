...
const Heading = styled(BaseHeading)(({primary, secondary, tertiary, subHeading}: Props) => [
  ...
  secondary && tw`mb-8 text-4xl md:text-5xl leading-normal`,
  tertiary && tw`text-3xl leading-[1.2] mb-8`,
  subHeading && tw`font-sans block text-sm font-medium text-primary-shade-1 uppercase mb-4 tracking-[0.75px]`,
])
